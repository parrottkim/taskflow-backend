...
export class UpdateSchedule1762916122999 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "trip_fuel_expense" DROP COLUMN "mileage"`,
    );
    await queryRunner.query(
      `ALTER TABLE "trip_fuel_expense" ADD "mileage" numeric(12,2) NOT NULL DEFAULT 0`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "trip_fuel_expense" ADD "mileage" integer NOT NULL`,
    );
  }
}
